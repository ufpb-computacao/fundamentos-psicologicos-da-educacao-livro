...
uma frase chave: a ação produz desenvolvimento (<<"SPRINTHALL","SPRINTHALL, 2004">>). 
// Faltando referência a Piaget 1970
...
De acordo com <<"PAPALIA","Papalia (2010)">> o envelhecimento primário
...
velhice muito avançada. Porém, segundo <<"PAPALIA", "Papalia (2010)">>, a 
...
Segundo, ainda, <<"SHEPHARD","Shephard (2003)">>, a categorização
...
complexidade do processo intelectual do ser humano. <<"PAPALIA",
