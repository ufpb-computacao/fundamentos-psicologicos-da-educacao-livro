...
que ficou conhecido como _Nível de Desenvolvimento Real_.
Mas existe determinada tarefa que esse mesmo indivíduo só pode
desenvolver com a ajuda de alguém, que seria o _Nível de Desenvolvimento Potencial_
(nível que ainda não foi alcançado, mas está próximo de se consolidar).
A partir da constatação desses dois níveis de desenvolvimento
(Real e Potencial), Vygotsky definiu a *((Zona de Desenvolvimento Proximal))*.
