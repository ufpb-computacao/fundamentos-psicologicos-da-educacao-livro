...
Figura Gesell em observação e registro
(Foto de Cushing / Whitney Medical Library)
****
...
figura Burrhus Skinner

Burrhus Skinner em ação (condicionamento operante de animais)
Fonte: http://webspace.ship.edu/cgboer/genpsylearning.html
****
