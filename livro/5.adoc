...
Piaget a partir de estudo/observação do comportamento infantil e
adolescente e que representam fundamentos para alcançarmos também a
compreensão do comportamento intelectivo adulto e idoso. Nessa perspectiva:
...
Ilustramos a seguir as fases de desenvolvimento cognitivo estudadas
por Piaget.

.Fases do desenvolvimento cognitivo na perspectiva piagetiana
image::{img}/esquema5.eps[scaledwidth="70%"]
...
isto é, de revolucionário no plano das ideias, ele se
...
Vygotsky, em seus estudos, destacou a importância da relação
do indivíduo com o ambiente sócio cultural, sendo assim, deu
importância a interação social na construção da aprendizagem.
Nessa perspectiva, ele passou a estudar a importância de
compreender ``até onde o indivíduo chegou'', ou seja, o que pode fazer sozinho,
que ficou conhecido como _Zona de Desenvolvimento Real_.
Mas existe determinada tarefa que esse mesmo indivíduo só pode
desenvolver com a ajuda de alguém, que seria o Desenvolvimento Potencial
(nível de desenvolvimento que ainda não foi alcançado,
mas está próximo de se consolidar).
A partir da constatação desses dois níveis de desenvolvimento
(Real e Proximal), Vygotsky definiu a Zona de Desenvolvimento Proximal.
Essa Zona Proximal seria a ponte entre o que o indivíduo pode fazer sozinho
e o que pode fazer com a ajuda do outro social, até o momento que ocorre
a aprendizagem completa.

Na <<fig_zona_desenvolvimento>> podemos visualizar a Teoria da Zona de
Desenvolvimento Proximal.

[[fig_zona_desenvolvimento]]
.Teoria da Zona de Desenvolvimento Proximal
image::{img}/Papel-da-Escola-no-Desenvolvimento-Cognitivo.eps[]

A seguir, podemos ler um pouco sobre as ideias de Vygotsky acerca da relação
entre linguagem e pensamento.

[cols=">", frame="none"]
|====
| Texto complementar: *Pensamento e palavra*
| Autor: Vygotsky (1993)
|====
...
[cols=">", frame="top"]
|====
| Final do texto: *Pensamento e palavra*, Vygotsky (1993).{sp}
|====

Consideramos que o estudo acerca do desenvolvimento cognitivo a partir das
contribuições de Piaget e Vygotsky possibilita compreender quão
importante é o aprofundamento dos estudos sobre
como se desenvolve a inteligência humana e quanto a
