...
=== Explicando o mito da Alegoria da Caverna e sua relação com a educação.
...
além do mundo sensível. A educação em função da expressão do seu pensamento, ele quereria 
