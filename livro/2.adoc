...
O esquema 04 demonstra a relaçã entre a Tricotomia Cartesiana
...
O quadro 01 ilustra um pouco do caminho percorrido por Arnold Gesell,
...
Quadro 01: ilustração do caminho teórico percorrido por Arnold Gesell.
...
Veja a seguir, a visão de Skinner acerca do estudo do comportamente.
...
principalmente na definição que faz do papel da escola: ajudar o 
...
Segue abaixo um pequeno resumo acerca dos estudos de Freud, base da psicanálise.
...
Quadro 04: Curiosidade acerca da teoria psicogenética. Extraído da Fonte: 
...
No quadro a seguir, temos um pouco da Teoria das Hierarquias das Necessidades
de Maslow, também, largamente utilizada, no campo da gestão de pessoas.
...
REFAZER A PIRÂMIDE (ONDE SE LÊ: "Amor/relacionamento" colocar: "Amor/Pertencimento". 
Onde se lê: fisiologia. Colocar: fisiológicos)
...
Quadro 05: extraído da fonte: http://www.infoescola.com/biografias/abraham-maslow/
...
Para Vygotsky, a aprendizagem seria uma experiência social, a qual é mediada pela 
...
Finalizando o capítulo, apresentamos, com quadro 06, um resumo das teorias da psicologia 
