...
image::{img}/descartes-mapa.png[scaledwidth="90%"]


////

Descartes
    Áreas distintas do ser para estudo do método
        Alma: pensamento (Cogito: penso logo existo)
        Deus (divina): infinito
        Corpo: estruturas mentais, extensão da alma/física
    Conhecimento
        Deve ser Seguro
        Aplica a Dúvida Metafórica (Método científico)
