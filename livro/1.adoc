...
Inicialmente devemos considerar que a escolha de um curso de 
...
No esquema 01, podemos visualizar o estudo da consciência pela relação 
...
Vejamos, no esquema 02, como os estruturalistas visualizavam a relação 
...
Logo abaixo, no esquema 03, podemos identificar a base conceitual 
